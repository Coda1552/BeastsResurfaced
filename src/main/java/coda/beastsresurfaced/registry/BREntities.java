...
public class BREntities {
    ...
    public static final RegistryObject<EntityType<CowfishEntity>> COWFISH = create("cowfish", EntityType.Builder.of(CowfishEntity::new, MobCategory.CREATURE).sized(1.7F, 1.5F));
